...
import { LikeFilled, LikeOutlined, DislikeFilled, DislikeOutlined, SendOutlined } from '@ant-design/icons';
    ...
    <>
      <div className="max-w-[900px] bg-white px-16 pt-8 pb-8 mx-auto mt-8 flex flex-col items-center">
        ...
        <div className="flex w-full gap-4 mb-6">
          <Input onChange={handleComment} placeholder="Để lại comment của bạn" />
