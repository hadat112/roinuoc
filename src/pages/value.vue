...
<template>
  <div class="max-w-[960px] text-left mx-auto text-lg leading-10 my-16 bg-white px-8 py-4">
    <tabs v-model:activeKey="activeKey">
      ...
      >
      <tab-pane key="2" tab="Tab 2" force-render>
        <p class="tab-pane">
            {{giatri.giaoduc}}
        </p>
        </tab-pane
      >
      <tab-pane key="3" tab="Tab 3">
        <p class="tab-pane">      
            {{giatri.vanhoa}}
        </p>
    </tab-pane>
